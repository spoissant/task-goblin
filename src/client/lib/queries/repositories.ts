...
export function useUpdateRepository() {
  ...
  return useMutation({
    mutationFn: ({ id, ...data }: { id: number; owner?: string; repo?: string; alias?: string | null; enabled?: boolean; badgeColor?: string | null; deploymentBranches?: string[]; deploymentUrls?: Record<string, string> | null; slackChannel?: string | null; requiredReviews?: number; setupCommand?: string | null; teardownCommand?: string | null; defaultBaseBranch?: string | null }) =>
